...
class ExaSearchToolset():
    ...
    def search(query: str):
        ...
        """
        return ExaSearchToolset._exa().search( f"{query}", usse_autoprompt = True, num_results = 3 )
    ...
    def get_contents(ids: str):
        """
            ...
            The ids must be passes in as a list, a list of ids returned from 'search'.
        """
    ...
    def _exa():
        return Exa(api_key=os.environ.get.get('EXA_API_KEY'))